  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-sans tracking-wide",
  {
    variants: {
      variant: {
        ...
        hero: "bg-accent text-white hover:bg-accent/90 shadow-[0_0_30px_hsl(18_85%_28%/0.3)] hover:shadow-lg transform hover:scale-105",
        mountain: "bg-[hsl(215_30%_12%)] text-white hover:bg-[hsl(215_20%_25%)] shadow-[0_4px_20px_-4px_hsl(215_30%_12%/0.1)] hover:shadow-lg",
        whatsapp: "bg-[hsl(142_70%_22%)] text-white hover:bg-[hsl(142_70%_18%)] shadow-[0_4px_20px_-4px_hsl(215_30%_12%/0.1)] hover:shadow-lg",
